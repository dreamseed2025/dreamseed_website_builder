...
DROP TABLE IF EXISTS dream_dna_type CASCADE;
DROP TABLE IF EXISTS dream_dna_probability_truth CASCADE;
DROP TABLE IF EXISTS dream_dna_truth CASCADE;

-- Recreate dream_dna_truth table with correct foreign key
...
-- Recreate dream_dna_probability_truth table
...
-- Create policies
CREATE POLICY "Allow all operations on dream_dna_truth" ON dream_dna_truth FOR ALL USING (true);
CREATE POLICY "Allow all operations on dream_dna_probability_truth" ON dream_dna_probability_truth FOR ALL USING (true);
CREATE POLICY "Allow all operations on dream_dna_type" ON dream_dna_type FOR ALL USING (true);
